...
Add bilingual (zh_CN / en) support to all user-facing surfaces. Language auto-detects from `navigator.language` (`chrome.i18n.getUILanguage()`) — no manual override. App name: "灵译" (Chinese) / "iTranslate" (English).
